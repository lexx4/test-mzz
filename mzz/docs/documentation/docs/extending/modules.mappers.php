<p>Часто бывает, что необходимо поменять некоторые вещи в коробочных модулях MZZ, например,
...
<p>MZZ предлагает немного иной подход к проблеме переопределения частей модуля в приложениях. Рассмотрим его на примере модуля user.</p>

<p>Мы имеем userMapper.php следующего содержания (тело класса скрыто, весь листинг вы можете посмотреть, открыв файл &lt;MZZ&gt;/system/modules/user/mappers/userMapper.php):</p>
<<code php>>

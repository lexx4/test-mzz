...
<p>По адресу <tt>http://MZZ.blog/ru/blog/welcome</tt> мы увидим 404 ошибку. Произошло это из-за того, что по умолчанию контроллер <tt>blogViewController</tt> сгенерировался для работы с числовым идентификатором (id):</p>
<<code php>>
